    ...
    function (req, res, next) {
      Dishes.findById(req.params.dishId)
        .then(
          (dish) => {
            if (dish !== null) {
              console.log('ENTRE AL POST COMENTARIOS');
              console.log(req.decoded);
              req.body.author = req.decoded._id._id;
...
dishRouter
        ...
        .then(
          (dish) => {
            if (
              ...
              if (req.decoded._id._id === dish.comments.author._id) {
                if (req.body.rating) {
  ...
  .delete(
    authenticate.verifyOrdinaryUser,
    authenticate.verifyAdminComments,
    (req, res, next) => {
      Dishes.findById(req.params.dishId)
        .then(
          (dish) => {
